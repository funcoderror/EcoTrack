        ...
        <header className="w-full border-b border-gray-800">
          <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
            <Link to="/" className="flex items-center gap-3">
              <svg className="h-8 w-8 text-green-500" xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 48 48">
        ...
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="w-full max-w-md p-8 space-y-8 bg-gray-900/80 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-700">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-400">Sign in to continue to Ecotrack</p>
            </div>
              ...
              <div className="rounded-lg space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 rounded-lg border border-gray-600 bg-gray-800 text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
